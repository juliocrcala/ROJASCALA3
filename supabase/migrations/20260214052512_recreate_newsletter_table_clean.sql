/*
  # Recreate Newsletter Subscribers Table
  
  1. Purpose
    - Drop and recreate newsletter_subscribers table cleanly
    - Ensure PostgREST can properly detect the table
    - Set up proper permissions and RLS from scratch
